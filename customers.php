...
<title>Customers| Bank-TSF</title>
<style>
body {
margin:0;
padding:0;
...
<section class="page-footer">
    ...
    <div class="footer-bottom">
        <p class="footer-content">Designed & Developed with <i class="fa fa-clock-o" style="color: red;"></i> by <a href="devloper.html">Shravan Malviya</a></p>
    </div>
</section>
</body>
</html> 
